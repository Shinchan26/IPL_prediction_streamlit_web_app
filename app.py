...
st.sidebar.image("picture/iplimages.jpg")
st.sidebar.image("picture/image4.jpg")
st.sidebar.image("picture/image5.png")
...
st.sidebar.radio('Pages', options=['Model ','Team','IPL'])
